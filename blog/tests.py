...
class TestView(TestCase):
    def setUp(self):
        ...
        self.category_programming=Category.objects.create(name='programming',
                                                          slug='programming')
        self.category_music=Category.objects.create(name='winter',
                                                    slug='winter')
        self.post_001 = Post.objects.create(
            title='첫번째 포스트입니다.',
            content='첫번째 포스트 내용입니다.',
            category=self.category_music,
            author=self.user_trump,
        )
        self.post_002 = Post.objects.create(
            title='두번째 포스트입니다.',
            content='두번째 포스트 내용입니다.',
            category=self.category_programming,
            author=self.user_obama,
        )
        self.post_003 = Post.objects.create(
            title='세번째 포스트입니다.',
            content='세번째 포스트 내용입니다.',
            author=self.user_obama,
        )
    ...
    def test_post_list(self):
        ...
        # 1.4 내비게이션 바가 있다.
        # 1.5 Blog, About Me 라는 내비게이션 바가 있다.
        self.navbar_test(soup)

        # # 2.1 메인 영역에 게시물이 하나라도 없다면
